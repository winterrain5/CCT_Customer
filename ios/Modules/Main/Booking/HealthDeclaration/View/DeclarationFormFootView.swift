  ...
  var healthDeclarationType:String? {
    didSet {
      ...
      if healthDeclarationType == 3 {
        terms = "I confirm that I am not having a high-risk pregnancy and I have stated all my known medical conditions. I understand that I will be receiving massage therapy for stress reduction, muscle relief, and/or improving circulation and energy flow. I understand that the massage therapist does not and cannot diagnose illnesses. She also does not prescribe medical treatment or medications. I also understand that she does not perform spinal manipulations. I am aware that this massage is not a substitute for medical examination or diagnosis, and that it is recommended that I see a physician for any ailment that I might have. I understand and accept all risks arising from the massage therapy that I, on my own volition, have agreed to receive. In the event that I become injured either directly or indirectly as a result, in whole or in part, of the aforesaid massage therapy I HEREBY INDEMNIFY AND HOLD HARMLESS the therapist, her principles, and Chien Chi Tow Healthcare Pte Ltd from all claims and liability whatsoever."
      }
