//
//  HealthCareDeclarationController.swift
//  CCTIOS
//
...
import UIKit
import PromiseKit
class HealthCareDeclarationController: BaseTableController {
  ...
  func savePatientResults(_ sender:LoadingButton) {
    ...
    summary_data.set(key: "category", value: 1)
    ...
    data.set(key: "health_lines_data", value: lines_Data.result,keyType: .string,valueType: .map(1))
