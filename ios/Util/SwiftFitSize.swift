...
//  VictorOnlineParent
//
//  Created by Derrick on 2020/6/30.
...
@objc public final class SwiftyFitsize: NSObject {
    ...
    /// 默认参照宽度
    @objc public var referenceW: CGFloat = 375
    /// 默认 iPad 适配缩放倍数 (0 , 1]
...
public postfix func ~ (font: UIFont) -> UIFont {
    return UIFont(name: font.fontName, size: floor(font.pointSize~)) ?? font
}
public postfix func ~ (value: Int) -> CGFloat {
    return floor(CGFloat(value)~)
}
