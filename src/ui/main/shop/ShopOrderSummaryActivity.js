...
export default class ShopOrderSummaryActivity extends Component {
  ...
  UNSAFE_componentWillMount(){
    ...
    if (this.props.route && this.props.route.params) {
      ...
      this.getHistoryOrderDetails(this.props.order_id);
      ...
      for (var i = 0; i < this.state.order_detalis.Order_Line_Info.length; i++) {
        ...
        items.push(
          ...
          <View style = {{width:'100%'}} key = {i + ''}>
              ...
              {i != this.state.order_detalis.Order_Line_Info.length - 1 ? <View style = {styles.view_line} /> : <View/>}
  ...
  clickHelp(){
    ...
    if (this.props.pressLeft) {
     ...
     DeviceEventEmitter.emit('shop_over','ok');
  ...
  totalView(){
    ...
    if (freight == 0) {
      ...
      if (this.state.order_detalis && this.state.order_detalis.Order_Info.address) {
      ...
      } else if (this.state.order_detalis && this.state.order_detalis.Order_Line_Info &&  this.state.order_detalis.Order_Line_Info.length > 0) {
          ...
          <SafeAreaView style = {styles.afearea} >
              ...
              <View style = {styles.view_content}>
                ...
                <ScrollView style = {styles.scrollview}
                  ...
                  <Text style = {styles.text_order_title}>Your order has been confirmed!</Text>



                  <View style = {styles.view_item}>

                        <Text style = {styles.text_item_title}>{'Date of Order ' + (this.state.order_detalis ?  DateUtil.getShowTimeFromDate4(this.state.order_detalis.Order_Info.invoice_date) : '')}</Text>
                 ...
                 <View style = {styles.next_view}>
                    ...
                    <TouchableOpacity style = {[styles.next_layout]}  
                      ...
                      <Text style = {styles.next_text}>Return to Shop</Text>
